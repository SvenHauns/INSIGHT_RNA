...
if __name__ == "__main__":
    ...
    for target_z in dms_targets_inds:
        ...
        if os.path.isdir(args.target_folder_3utr) == False: os.mkdir(args.target_folder_3utr)
        if os.path.isdir(args.target_folder_3utr + id_[1:-1] + "/") == False: os.mkdir(args.target_folder_3utr + id_[1:-1] + "/")
        ...
        shape_file6 = args.target_folder_3utr + id_[1:-1] + "6.shape.fa"
